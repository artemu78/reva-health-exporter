...
class MainActivity : ComponentActivity() {
    ...
    private val emaSettingsController by lazy { EmaSettingsController(this) }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        emaSettingsController.setup()
        emaSettingsController.reconcileSchedule()
    ...
    override fun onResume() {
        ...
        renderExportStatus()
        emaSettingsController.renderSummary()
    }
